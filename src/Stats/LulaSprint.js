...
import {COLOR_LULA, COLOR_OTHER} from '../colors';
...
export default function LulaSprint() {
  ...
  const startDate = DateTime.fromISO('2023-09-20');
  const endDate = DateTime.fromISO('2023-10-03');
